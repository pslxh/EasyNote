...
public class PerformEdit {
    ...
    private String first_editable;

    public PerformEdit(@NonNull EditText editText, String frist_text) {
        CheckNull(editText, "EditText不能为空");
        this.first_editable = frist_text;
    ...
    private class Watcher implements TextWatcher {
        ...
        public final void afterTextChanged(Editable s) {
            ...
            if (first_editable.equals(s.toString())) {
                clearHistory();
                return;
            }
            if (s != editable) {
            ...
            if (!TextUtils.isEmpty(s)) canUndo(true);
        }
